...
- Avec `let`, on peut réassigner une variable. Avec `const`, il n'est pas possible de réassigner une variable. ATTENTION : On peut toujours modifier un objet ou un tableau par mutation.
...
- On peut érire la fonction flèche avec un `return` implicite en retirant les accolades `{}`
...
const person1 = { name: 'Donald', age: 77, age: 78, age: 79 };

displayJson(person1); //{ name: 'Donald', age: 79 };
...
const obj1 = { name: 'Donald', address: { city: 'Washington', state: 'DC' } };
...
const obj1 = { name: 'Donald', age: 79 };

const obj2 = { ...obj1 }; //clone

obj2.age = 80; // modify age property
obj2['age'] = 81; // use bracket notation
Object.assign(obj2, { age: 82 }); // Mutates the obj2 object
...
const addProp = { ...obj1, city: 'Washington' }; //clone
