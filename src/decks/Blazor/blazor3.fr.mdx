...
Cet événement est lancé APRÈS l'initialisation et APRÈS avoir reçu les paramètres, mais AVANT le rendu et l'affichage à l'usager. C'est défini dans le composant de de base de Blazor.
...
## Appeler le sevice pour obtenir données
