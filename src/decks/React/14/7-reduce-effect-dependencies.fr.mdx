---
title: 'Réduire les dépendances des Effects'
---

# Réduire les dépendances d'Effects
...
## Dépendances doivent correspondre au code
...
- Il faut démontrer que ce n'est pas une dépendance
...
## Pour changer les dépendances, il faut modifier le code
...
## Deep Dive: Supprimer le linter est dangereux
...
## Retirer les dépendances non-nécessaires
...
## Déplacer le code vers un gestionnaire d'événment
...
## Déplacer le code de l'Effect vers un Événement
...
## Effect fait plusieurs choses indépendantes
...
```js {3-11,15}
    // 🔴 Avoid: A single Effect synchronizes
...
## Lecture de l'état pour générer le prochain état
...
## Lire une valeur sans qu'elle ne soit "réactive" aux changements
...
## Encapsuler un gestionnaire d'événement dans les props
...
## Nouvelle fonction passée à chaque rendu
...
Since `onReceiveMessage` is a dependency, it would cause the Effect to re-synchronize after every parent re-render. This would make it re-connect to the chat.

---

## Résoudre le problème

To solve this, wrap the call in an Effect Event:
...
## Valeurs réactives qui changent
...
## Valeurs reactives sont des dépendances
...
## Déplacer les objets statiques hors du composant
...
## Déplacer les fonctions hors du composant
...
## Déplacer les objets et fonctions dynamiques dans l'Effect
...
## Lire les valeurs primitives des objets
...
This would cause your Effect to re-connect every time the parent component re-renders.

---

## Déplacer le code

To fix this, read information from the object _outside_ the Effect, and avoid having object and function dependencies:
...
## Calculer des valeurs primitives des fonctions
...
## Réparer un intervalle qui resynchronise
...
## Réparer une animation en boucle
...
## Réparer un clavardage qui se reconnecte
