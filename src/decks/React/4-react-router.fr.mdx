...
import Code1 from './4-react-router/code1.fr.mdx';
...
import Code2 from './4-react-router/code2.en.mdx';
...
import Code3 from './4-react-router/code3.en.mdx';
...
import Code4 from './4-react-router/code4.en.mdx';
...
import Code5 from './4-react-router/code5.en.mdx';
...
Composant génèrant un hyperlien, capture l'événement clic prenant en charge le "History API".
...
import Code6 from './4-react-router/code6.en.mdx';

<Code6 components={props.components} />

---

import Code7 from './4-react-router/code7.en.mdx';
