...
<Diagram name="generic_render_tree" height={250} width={500} alt="">

Une arborescence de rendu

</Diagram>

- Les composants en haut, près de la racine, sont des composant de "top-niveau" (parfois: "container" )
- Les composants en bas, sans enfants, sont des composants "feuilles" (parfois: "presentation")
- Catégoriser est utile:
  - Permet de comprendre le flot de données
  - Permet de d'analyser la performance du rendu
