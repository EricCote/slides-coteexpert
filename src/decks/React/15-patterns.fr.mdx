...
- Un HOF, c'est une fonction qui prend un fonction en entrée, et qui retourne retourne une nouvelle fonction

- Cette fonction retournée enveloppe ("wrap") la fonctionalité de la fonction d'entrée via composition fonctionnelle
...
Cette technique est plus récente et plus populaire
...
Variation avec un div. Recommandé.
