...
import Code1 from './8-react-router/code1.fr.mdx';
...
import Code2 from './8-react-router/code2.en.mdx';

<Code2 components={props.components} />

---

import Code2b from './8-react-router/code2b.en.mdx';

<Code2b components={props.components} />
...
import Code3 from './8-react-router/code3.en.mdx';

<Code3 components={props.components} />

---

import Code3b from './8-react-router/code3b.en.mdx';

<Code3b components={props.components} />

---

import Code3c from './8-react-router/code3c.en.mdx';

<Code3c components={props.components} />
...
Un lien avec path permet d'être compatible avec les approches React telles que:
...
(**Note:** certaines sources prétendent que les engins de recherche favorisent les _path_ plutôt que les _hash_, mais d'autres prétendent que ce n'est pas le cas.)
...
import Code4 from './8-react-router/code4.en.mdx';

<Code4 components={props.components} />

---

import Code4b from './8-react-router/code4b.en.mdx';

<Code4b components={props.components} />
...
import Code5 from './8-react-router/code5.en.mdx';

<Code5 components={props.components} />

---

import Code5b from './8-react-router/code5b.en.mdx';

<Code5b components={props.components} />
...
import Code6 from './8-react-router/code6.en.mdx';

<Code6 components={props.components} />

---

import Code7 from './8-react-router/code7.en.mdx';

<Code7 components={props.components} />

---

import Code7b from './8-react-router/code7b.en.mdx';

<Code7b components={props.components} />
