...
Notre composant chatRoom affiche la chambre de communication.
...
## Evitez les Synchronisations dans un même Effect
...
## Ajouter une valeur réactive à l'Effect
...
#### Les valeurs mutables et variables globales ne peuvent être des dépendance
...
## Comment éviter la re-synchronisation
...
## Déplacer ces valeurs dans l'effect

Ces valeurs peuvent être déclarées dans l'Effect. Ces valeurs ne sont pas utilisées pendant le rendu, elles ne sont pas réactives.
