...
2. **Fonction state setter (Fonction modification d'état)** pour modifier la donnée et générer un rendu.
...
- L'état (State) est une fonctionalité, mais on en verra d'autres.
