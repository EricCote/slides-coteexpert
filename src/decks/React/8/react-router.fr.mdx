...
import Code1 from './code1.fr.mdx';
...
import Code2 from './code2.en.mdx';

<Code2 components={props.components} />

---

import Code2b from './code2b.en.mdx';
...
<div >
<img  src='./AngryCat.jpeg' style={{ marginInlineStart: 30, width: 300, float: 'right' }} />
...
import Code3 from './code3.en.mdx';

<Code3 components={props.components} />

---

import Code3b from './code3b.en.mdx';

<Code3b components={props.components} />

---

import Code3c from './code3c.en.mdx';
...
import Code4 from './code4.en.mdx';

<Code4 components={props.components} />

---

import Code4b from './code4b.en.mdx';
...
import Code5 from './code5.en.mdx';

<Code5 components={props.components} />

---

import Code5b from './code5b.en.mdx';
...
import Code6 from './code6.en.mdx';

<Code6 components={props.components} />

---

import Code7 from './code7.en.mdx';

<Code7 components={props.components} />

---

import Code7b from './code7b.en.mdx';
