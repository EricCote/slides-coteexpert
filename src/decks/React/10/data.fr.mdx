...
StartTransition indique un changement de State non-bloquant, dont le rendu n'est pas urgent. Ne provoque pas un suspense parent. Si un autre événement lance un setState, le rendu de transition est interrompu (et redémarré plus tard, une fois le traitement de l'événement terminé).
