...
import Code1 from './react-router/code1.en.mdx';
...
Even then, the influence of React Router is felt...
...
Hyperlink Component, with click event that makes this compatible to the _History API_.
